...
if creditsMode
{
	...
	draw_set_font(Font1)
	draw_text_scoreboard(display_get_gui_width()/2 - 600, display_get_gui_height()/2 - 50, 
	"The Funkin' Crew, Inc. - Original internal tool\nicomiki - Creator of Funkin' Launcher\nTori - Background Launcher Art")
}
...
else
{
	...
	draw_text_scoreboard(display_get_gui_width()/2 - 600, display_get_gui_height()/2 - 50,
	"Workflow: " + buildInfo.workflow_runs[arrayIndex].name 
	+ "\nActor: " + buildInfo.workflow_runs[arrayIndex].actor.login 
	+ "\nRun at: " + buildInfo.workflow_runs[arrayIndex].run_started_at
